...
arrow::write_parquet(diag_df,
  file.path(diag_dir, "london_may_sep_diagnostics.parquet"))
...
write.csv(ranef_df,
  file.path(diag_dir, "london_may_sep_ranef.csv"), row.names = FALSE)
...
write.csv(aic_df, file.path(diag_dir, "london_may_sep_aic.csv"), row.names = FALSE)
...
write.csv(vc_df, file.path(diag_dir, "london_may_sep_varcomp.csv"), row.names = FALSE)

cat("  -> diagnostics/london_may_sep_diagnostics.parquet\n")
cat("  -> diagnostics/london_may_sep_ranef.csv\n")
cat("  -> diagnostics/london_may_sep_aic.csv\n")
cat("  -> diagnostics/london_may_sep_varcomp.csv\n")
