...
arrow::write_parquet(diag_df,
  file.path(diag_dir, "southwest_august_diagnostics.parquet"))
...
write.csv(ranef_df,
  file.path(diag_dir, "southwest_august_ranef.csv"), row.names = FALSE)
...
write.csv(aic_df, file.path(diag_dir, "southwest_august_aic.csv"), row.names = FALSE)
...
write.csv(vc_df, file.path(diag_dir, "southwest_august_varcomp.csv"), row.names = FALSE)

cat("  -> diagnostics/southwest_august_diagnostics.parquet\n")
cat("  -> diagnostics/southwest_august_ranef.csv\n")
cat("  -> diagnostics/southwest_august_aic.csv\n")
cat("  -> diagnostics/southwest_august_varcomp.csv\n")
