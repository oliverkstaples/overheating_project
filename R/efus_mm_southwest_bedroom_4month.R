#!/usr/bin/env Rscript
# efus_mm_southwest_bedroom_4month.R
#
...
arrow::write_parquet(diag_df,
  file.path(diag_dir, "southwest_may_sep_bedroom_diagnostics.parquet"))
...
write.csv(ranef_df,
  file.path(diag_dir, "southwest_may_sep_bedroom_ranef.csv"), row.names = FALSE)
...
write.csv(aic_df, file.path(diag_dir, "southwest_may_sep_bedroom_aic.csv"), row.names = FALSE)
...
write.csv(vc_df, file.path(diag_dir, "southwest_may_sep_bedroom_varcomp.csv"), row.names = FALSE)

cat("  -> diagnostics/southwest_may_sep_bedroom_diagnostics.parquet\n")
cat("  -> diagnostics/southwest_may_sep_bedroom_ranef.csv\n")
cat("  -> diagnostics/southwest_may_sep_bedroom_aic.csv\n")
cat("  -> diagnostics/southwest_may_sep_bedroom_varcomp.csv\n")
